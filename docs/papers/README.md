...
| --- | --- | --- | --- | --- | --- |
| Missing; noninteractive access blocked as of 2026-06-01 | `DecentKing2008_IMAJAM_73_1_37-68_hxm043.pdf` | S. P. Decent and A. C. King, "Surface-tension-driven flow in a slender cone," *IMA Journal of Applied Mathematics* **73**(1), 37--68, 2008. | DOI [`10.1093/imamat/hxm043`](https://doi.org/10.1093/imamat/hxm043) | Primary target for source-fidelity work. OUP PDF endpoint `https://academic.oup.com/imamat/article-pdf/73/1/37/1920099/hxm043.pdf` and DOI landing flow returned HTTP 403 Cloudflare challenge pages (`cf-mitigated: challenge`, "Just a moment...") to bounded `curl` and headless Playwright attempts; no PDF saved. | TODO once acquired locally |
| Present locally; ignored | `Billingham1999_JFM_397_45.pdf` | J. Billingham, "Surface-tension-driven flow in fat fluid wedges and cones," *Journal of Fluid Mechanics* **397**, 45--71, 1999. | DOI [`10.1017/S0022112099006047`](https://doi.org/10.1017/S0022112099006047) | Downloaded 2026-06-01 from the Cambridge Core service PDF endpoint; verified `%PDF-` header and PDF metadata title/author. The previous local file with this filename was a different JFM paper and has been quarantined below. | `4795bd1ec4643178dee0b137d40e6a9bee7fa06bfd6bcec4382e833feadc644b` |
...
| PDF missing; page image present; noninteractive access blocked as of 2026-06-01 | `KellerKingTing1995_PoF_7_226.pdf` | J. B. Keller, A. C. King, and L. Ting, "Blob formation," *Physics of Fluids* **7**(1), 226--228, 1995. | DOI [`10.1063/1.868723`](https://doi.org/10.1063/1.868723) | Only `KellerKingTing1995_page.png` is currently present. AIP DOI flow and direct PDF endpoint `https://pubs.aip.org/aip/pof/article-pdf/7/1/226/440022/226_1_online.pdf` returned HTTP 403 Cloudflare challenge pages (`cf-mitigated: challenge`, "Just a moment...") to bounded `curl` and headless Playwright attempts; acquire and checksum the PDF before citing quantitative details. | TODO once acquired locally |
